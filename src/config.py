...
TRAIN_DATA_NAME= 'data.7'
TRAIN_LABEL_NAME= 'label.7'

VALIDATION_DATA_NAME= 'data.7'
VALIDATION_LABEL= 'label.7'

TEST_DATA_NAME= 'data.7'
TEST_LABEL_NAME= 'label.7'

INFERENCE_RESULT_NAME='result.7'
